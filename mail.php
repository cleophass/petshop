...
<body>
    ...
    function sendEmail($subject, $to)
    {
        ...
        $mail->Body .= '<h1 style="font-family: Trebuchet MS, Arial, Helvetica,
         sans-serif;font-size: 40px;text-align: center;color:#003049;">
	...
	<h3 style="font-family: Trebuchet MS, Arial, He
    lvetica, sans-serif;font-size: 20px;text-align:
        center;font-style: italic;">if you have a question about your order you can contact us:
